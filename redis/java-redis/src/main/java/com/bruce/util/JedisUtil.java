...
public class JedisUtil {
    ...
    static {
        ...
        String pass = properties.getProperty("redis.password");
        ...
        Integer defaultDB = Integer.valueOf(properties.getProperty("redis.default.db"));
        ...
        jedisPool = new JedisPool(config, host, Integer.parseInt(port), Integer.parseInt(timeout),  pass, defaultDB);
    }
    ...
    public boolean setnx(String key, String val, long expire) {
        Jedis jedis = null;
        try {
            jedis = getJedis();
            if (jedis == null) {
            ...
            return jedis.set(key, val, new SetParams().nx().px(expire)).equalsIgnoreCase("ok");
