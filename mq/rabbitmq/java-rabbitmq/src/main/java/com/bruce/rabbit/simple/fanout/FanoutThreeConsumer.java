 ...
 * @description TODO
 */
public class FanoutThreeConsumer {

    public final static String FANOUT_EXCHANGE = "FANOUT_EXCHANGE";
    public final static String FANOUT_THREE_QUEUE = "FANOUT_THREE_QUEUE";
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueDeclare(FANOUT_THREE_QUEUE, false, false, false, null);
        System.out.println(" Waiting for message....");

        // 绑定队列和交换机
        channel.queueBind(FANOUT_THREE_QUEUE, FANOUT_EXCHANGE, "");
        ...
        channel.basicConsume(FANOUT_THREE_QUEUE, true, consumer);
    }
