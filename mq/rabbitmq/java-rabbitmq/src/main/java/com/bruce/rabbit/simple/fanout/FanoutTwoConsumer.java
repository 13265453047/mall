...
public class FanoutTwoConsumer {
    ...
    public final static String FANOUT_TWO_QUEUE = "FANOUT_TWO_QUEUE";
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueDeclare(FANOUT_TWO_QUEUE, false, false, false, null);
        System.out.println(" Waiting for message....");

        // 绑定队列和交换机
        channel.queueBind(FANOUT_TWO_QUEUE, FANOUT_EXCHANGE, "");
        ...
        channel.basicConsume(FANOUT_TWO_QUEUE, true, consumer);
    }
